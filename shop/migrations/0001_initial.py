# Generated by Django 2.2.12 on 2020-10-09 11:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categories_product', models.CharField(choices=[('E7', 'EV_7KW'), ('E2', 'EV_22KW'), ('EC', 'EV_CABLE'), ('PM', 'PV_MODULES'), ('PI', 'PV_INVERTERS'), ('PO', 'PV_OTHERS')], default='E7', max_length=2)),
