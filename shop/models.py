...
class BaseCategory(models.Model):
    base_category_name = models.CharField(max_length=40, null=True, unique=True)

    class Meta:
        verbose_name_plural = "2. BaseCategory"

    def __str__(self):
        return str(self.base_category_name)

class Category(models.Model):
    category_name = models.CharField(max_length=40, null=True, unique=True)
    base_category = models.ForeignKey(BaseCategory, on_delete=models.SET_NULL, blank=True, null=True)
...
class SubCategory(models.Model):
    subcategory_name = models.CharField(max_length=40, null=True, unique=True)
...
class ShoppingAddress(models.Model):
    ...
    class Meta:
        verbose_name_plural = "8. ShoppingAddress"
